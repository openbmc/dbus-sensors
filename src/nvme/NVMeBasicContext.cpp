                           ...
                           std::vector<uint8_t>& resp)
{
    ...
    try
    {
        ...
        if (smbusPEC)
        {
            lg2::error("smpbusPEC {ADDR}' for bus '{BUS}'", "ADDR", lg2::hex, addr, "BUS", bus);
            // NOLINTNEXTLINE(cppcoreguidelines-pro-type-vararg)
