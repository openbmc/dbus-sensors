...
TEST_F(GpuMctpVdmTests, DecodeGetTemperatureReadingsResponseSuccess)
{
    ...
    packer.pack(static_cast<uint8_t>(gpu::aggregateTimestampTag));
...
TEST_F(GpuMctpVdmTests, DecodeGetTemperatureReadingsResponseSkipsMetadataTags)
{
    std::vector<uint8_t> buf(7 + 2 + 6 + 6 + 6);
    PackBuffer packer(buf);
    ...
    packer.pack(static_cast<uint8_t>(
        ocp::accelerator_management::CompletionCode::SUCCESS));
    packer.pack(static_cast<uint16_t>(3));
    packAggregateRecord(packer, gpu::aggregateMetadataTagMin,
                        aggregateFourByteTagInfo, 11 << 8);
    packAggregateRecord(packer, gpu::aggregateUuidTag, aggregateFourByteTagInfo,
                        12 << 8);
    packAggregateRecord(packer, 19, aggregateFourByteTagInfo, 40 << 8);
