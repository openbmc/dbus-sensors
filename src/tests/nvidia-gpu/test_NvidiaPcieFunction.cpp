...
class NvidiaPcieFunctionTestBase : public DbusMockTestBase
{
  protected:
        ...
        uint8_t functionNumber = 0, uint8_t eid = test_utils::defaultEid)
    {
        ...
        return std::make_shared<NvidiaPcieFunction>(
            conn, *mctpRequester, pcieDeviceName, invPath, eid, functionNumber,
            *objectServer, deviceType);
    }
...
TEST_F(NvidiaPcieFunctionTestBase, ConstructorGpuDoesNotCrash)
{
...
TEST_F(NvidiaPcieFunctionTestBase, ConstructorPcieDoesNotCrash)
{
...
TEST_F(NvidiaPcieFunctionTestBase, UpdatePcieSuccessSetsIds)
{
    mock_mctp::setNextResponse({}, test_utils::buildPcieScalarTelemetryResponse(
...
TEST_F(NvidiaPcieFunctionTestBase, UpdateGpuSuccessSetsIds)
{
    mock_mctp::setNextResponse({}, buildPcieScalarTelemetryV1Response(
                                       {0x10DE, 0x2330, 0x10DE, 0x1234}));
    auto func =
...
TEST_F(NvidiaPcieFunctionTestBase, UpdateInsufficientValuesNoSet)
{
...
TEST_F(NvidiaPcieFunctionTestBase, UpdateTruncatesTo16Bits)
{
    mock_mctp::setNextResponse({}, test_utils::buildPcieScalarTelemetryResponse(
...
TEST_F(NvidiaPcieFunctionTestBase, UpdateGpuVerifiesRequestEncoding)
{
    mock_mctp::setNextResponse({}, {});
    auto func =
...
TEST_F(NvidiaPcieFunctionTestBase, UpdatePcieVerifiesRequestEncoding)
{
    mock_mctp::setNextResponse({}, {});
...
TEST_F(NvidiaPcieFunctionTestBase, UpdateRequestContainsCorrectEid)
{
...
TEST_F(NvidiaPcieFunctionTestBase, UpdateWrongCommandByteDecodeError)
{
...
TEST_F(NvidiaPcieFunctionTestBase, UpdateMctpTransportErrorNoCrash)
{
...
TEST_F(NvidiaPcieFunctionTestBase, UpdateEmptyBufferNoCrash)
{
    mock_mctp::setNextResponse({}, {});
    auto func =
...
TEST_F(NvidiaPcieFunctionTestBase, UpdateTinyBufferNoCrash)
{
