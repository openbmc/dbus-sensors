...
class NvidiaGpuPowerControlTestBase : public DbusMockTestBase
{
  protected:
...
TEST_F(NvidiaGpuPowerControlTestBase, ConstructorDoesNotCrash)
{
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateSuccessSetsProperties)
{
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateUnlimitedPowerCapDisablesFlag)
{
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateZeroEnforcedDisablesFlag)
{
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateSendsRequest)
{
    mock_mctp::setNextResponse({}, {});
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateRequestContainsCorrectEid)
{
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateVerifiesRequestEncoding)
{
    mock_mctp::setNextResponse({}, {});
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateMctpTransportErrorNoCrash)
{
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateDecodeErrorNoCrash)
{
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateEmptyBufferNoCrash)
{
    mock_mctp::setNextResponse({}, {});
...
TEST_F(NvidiaGpuPowerControlTestBase, UpdateTinyBufferNoCrash)
{
...
TEST_F(NvidiaGpuPowerControlTestBase, DestructorRemovesInterface)
{
