...
TEST(NvlinkPortHealthMessage, SingleThreshold)
{
    EXPECT_EQ(
...
TEST(NvlinkPortHealthMessage, MultipleThresholds)
{
    EXPECT_EQ(
...
TEST(NvlinkPortHealthMessage, NoThresholds)
{
...
TEST(NvlinkPortHealthMessage, UnknownBits)
{
...
TEST(NvlinkPortHealthMessage, MixedKnownAndReservedBits)
{
...
TEST(NvlinkPortHealthMessage, DecodedEventProducesTheLogMessage)
{
