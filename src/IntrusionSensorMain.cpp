...
static constexpr const char* ncsiCablePath =
                ...
                for (const auto& interfacePair : pathPair.second)
                {
                    if (interfacePair.first == cableStatusConfiguration)
                    {
                        ...
                        auto findAssociationForward =
                            interfacePair.second.find("AssociationForward");
                        auto findAssociationReverse =
                            interfacePair.second.find("AssociationReverse");
                        ...
                        std::string associationForward = std::get<std::string>(
                            findAssociationForward->second);
                        std::string associationPath =
                            std::get<std::string>(findAssociationPath->second);
                        std::string associationReverse = std::get<std::string>(
                        ...
                        assocInterfaces[parentPath.str]->register_property(
                            "Associations",
                            std::vector<Association>{{associationForward,
                                                      associationReverse,
                                                      associationPath}});
