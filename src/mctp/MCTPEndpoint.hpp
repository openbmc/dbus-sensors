...
class USBMCTPDDevice : public MCTPDDevice
{
  ...
  private:
    ...
    static std::string busFromRootHubPath(const std::filesystem::path& rootHubPath);
    static std::string interfaceFromSysfs(const std::string& bus, const std::string& port,
