                                           ...
                                           std::string& propertyValue)
{
    ...
    else
    {
        ...
        // For Gpio based intrusion sensor, trigger readGpio() to update property
                                   ...
                                   bool gpioInverted)
{
    if (DEBUG)
    {
        std::cout << "enter ChassisIntrusionSensor::start \n";
        if (type == IntrusionSensorType::pch)
        {
            std::cout << "busId = " << busId << ", slaveAddr = " << slaveAddr
                      << "\n";
        }
        else if (type == IntrusionSensorType::gpio)
        {
            std::cout << "gpioIndex = " << gpioIndex
                      << ", gpioInverted = " << gpioInverted << "\n";
        }
    }

    if ((mType == IntrusionSensorType::pch && mBusId == busId &&
         mSlaveAddr == slaveAddr) ||
        (mType == IntrusionSensorType::gpio && mGpioIndex == gpioIndex &&
