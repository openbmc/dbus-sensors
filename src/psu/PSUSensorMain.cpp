...
static EventPathList eventMatch{{"PredictiveFailure", {"power1_alarm"}},
                                {"Failure", {"in2_alarm"}},
                                {"ACLost", {"in1_beep"}},
    ...
    bool activateOnly)
{
    ...
    for (const auto& pmbusPath : pmbusPaths)
    {
        ...
        for (const auto& sensorPath : sensorPaths)
        {
            ...
            PSUProperty psuProperty = *findProperty;
            ...
            else
            {
                ...
                sensorName = std::format("{} {}", psuNameFromIndex,
            ...
            else
            {
                sensors[sensorName] = std::make_shared<PSUSensor>(
                    ...
                    readState, findSensorUnit->units, factor,
