...
const static boost::container::flat_map<DevTypes, DevParams> devParamMap{
    ...
    bool activateOnly)
{
    ...
    for (const auto& pmbusPath : pmbusPaths)
    {
        ...
        auto param = devParamMap.find(devType);
        ...
        auto devParam = devParamMap.find(devType);
        ...
        std::regex sensorNameRegEx(devParam->second.nameRegEx);
        std::smatch matches;
        ...
        for (const auto& sensorPath : sensorPaths)
        {
            ...
            auto findSensorUnit = std::ranges::find_if(
            ...
            if constexpr (debug)
            {
                lg2::error("Sensor properties - Name: {NAME}, Scale: {SCALE}, "
                           ...
                           "NAME", labelTypeName, "SCALE", sensorScaleFactor,
                           "MIN", minReading, "MAX", maxReading, "OFFSET",
                           sensorOffset);
            }
