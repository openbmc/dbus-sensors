    ...
    NsmEccErrorCounts& errorCounts)
{
    ...
    errorCounts.flags = response->errorCounts.flags;
    errorCounts.sram_corrected = le64toh(response->errorCounts.sram_corrected);
    errorCounts.sram_uncorrected_secded =
        le64toh(response->errorCounts.sram_uncorrected_secded);
    errorCounts.sram_uncorrected_parity =
        le64toh(response->errorCounts.sram_uncorrected_parity);
    errorCounts.dram_corrected = le64toh(response->errorCounts.dram_corrected);
    errorCounts.dram_uncorrected =
        le64toh(response->errorCounts.dram_uncorrected);
