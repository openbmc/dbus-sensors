    ...
    std::shared_ptr<Inventory> inventory) : inventory(std::move(inventory))
{
    ...
    {
        lg2::error(
            "Failed to initialize processor Memory Capacity Utilization metric interface for GPU {NAME}",
            "NAME", deviceName);
    }
    ...
    {
        lg2::error(
            "Failed to initialize processor Memory Capacity Utilization metric association interface for GPU {NAME}",
            "NAME", deviceName);
    }
    ...
    {
        lg2::error(
            "Failed to initialize DRAM Memory Capacity Utilization metric interface for GPU {NAME}",
            "NAME", deviceName);
    }
    ...
    {
        lg2::error(
            "Failed to initialize DRAM Memory Capacity Utilization metric association interface for GPU {NAME}",
            "NAME", deviceName);
    }
