...
NvidiaGpuAssembly::NvidiaGpuAssembly(
    ...
    const std::string& chassisPath, Kind kind, uint8_t eid) :
    objectServer(objectServer)
{
    ...
    {
        lg2::error("Error initializing Panel interface for {PATH}, eid={EID}",
                   "PATH", path, "EID", eid);
    }
    ...
    {
        lg2::error("Error initializing Asset interface for {PATH}, eid={EID}",
                   "PATH", path, "EID", eid);
    }
    ...
    {
        lg2::error(
            "Error initializing PhysicalContext interface for {PATH}, eid={EID}",
            "PATH", path, "EID", eid);
    }
    ...
    {
        lg2::error(
            "Error initializing Embedded interface for {PATH}, eid={EID}",
            "PATH", path, "EID", eid);
    }
    ...
    {
        lg2::error("Error initializing Item interface for {PATH}, eid={EID}",
                   "PATH", path, "EID", eid);
    }
    ...
    {
        lg2::error(
            "Error initializing OperationalStatus interface for {PATH}, eid={EID}",
            "PATH", path, "EID", eid);
    }
    ...
    {
        lg2::error(
            "Error initializing Association interface for {PATH}, eid={EID}",
            "PATH", path, "EID", eid);
    }
}
