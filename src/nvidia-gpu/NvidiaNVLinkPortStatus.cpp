...
std::string mapPortStateToLinkStatus(uint8_t portState)
{
    ...
    switch (portState)
    {
        case 2:
            linkStatus = "LinkUp";
            break;
        // The physical link is up but the port cannot carry data yet, which
        // is what LinkStatus calls Starting.
        case 10:
            linkStatus = "Starting";
            break;
        case 7:
            linkStatus = "Training";
            break;
        // The port is still waiting for the receiver of a peer to be
        // detected, so no physical link has been detected on it.
        case 6:
            linkStatus = "NoLink";
            break;
        case 1:
        ...
        case 9:
            linkStatus = "LinkDown";
            break;
        // 3 is reserved by the specification, and any other value is one
        // this implementation does not know how to report.
        case 3:
        default:
            linkStatus = "Unknown";
            break;
