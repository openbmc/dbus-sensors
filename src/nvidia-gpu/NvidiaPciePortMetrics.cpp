...
void NvidiaPciePortErrors::update()
{
    ...
    mctpRequester.sendRecvMsg(
        eid, request,
        std::bind_front(&NvidiaPciePortErrors::processResponse, this));
}
...
void NvidiaPciePortCounters::update()
{
    ...
    mctpRequester.sendRecvMsg(
        eid, request,
        std::bind_front(&NvidiaPciePortCounters::processResponse, this));
}
...
void NvidiaPciePortL0ToRecoveryCount::update()
{
    ...
    mctpRequester.sendRecvMsg(
        eid, request,
        std::bind_front(&NvidiaPciePortL0ToRecoveryCount::processResponse,
                        this));
}
