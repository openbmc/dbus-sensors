...
void NvidiaPciePortErrors::processResponse(int sendRecvMsgResult)
{
...
void NvidiaPciePortCounters::processResponse(int sendRecvMsgResult)
{
    if (sendRecvMsgResult != 0)
    {
        lg2::error(
...
void NvidiaPciePortL0ToRecoveryCount::processResponse(int sendRecvMsgResult)
{
    if (sendRecvMsgResult != 0)
    {
        lg2::error(
