...
LldpIdSubtype toChassisIdSubtype(uint8_t value)
{
    switch (value)
    {
        case 1:
            return LldpIdSubtype::ChassisComp;
        case 2:
            return LldpIdSubtype::IfAlias;
        case 3:
            return LldpIdSubtype::PortComp;
        case 4:
            return LldpIdSubtype::MacAddr;
        case 5:
            return LldpIdSubtype::NetworkAddr;
        case 6:
            return LldpIdSubtype::IfName;
        case 7:
            return LldpIdSubtype::LocalAssign;
        default:
            return LldpIdSubtype::NotTransmitted;
    }
}

LldpIdSubtype toPortIdSubtype(uint8_t value)
{
    switch (value)
    {
        case 1:
...
std::string toIdentifier(LldpIdSubtype subtype, std::span<const uint8_t> value)
{
    switch (subtype)
    {
        case LldpIdSubtype::AgentId:
        case LldpIdSubtype::ChassisComp:
        case LldpIdSubtype::IfAlias:
        case LldpIdSubtype::IfName:
        case LldpIdSubtype::LocalAssign:
        case LldpIdSubtype::PortComp:
            return toText(value);
        case LldpIdSubtype::MacAddr:
        case LldpIdSubtype::NetworkAddr:
            return toHexadecimalOctets(value);
        case LldpIdSubtype::NotTransmitted:
        default:
            return {};
    }
}

std::vector<LldpSystemCapability> toCapabilities(uint16_t bits)
{
    static constexpr std::array<LldpSystemCapability, 8> byBit{
        LldpSystemCapability::Other,
        LldpSystemCapability::Repeater,
        LldpSystemCapability::Bridge,
        LldpSystemCapability::WLANAccessPoint,
        LldpSystemCapability::Router,
        LldpSystemCapability::Telephone,
        LldpSystemCapability::DOCSISCableDevice,
        LldpSystemCapability::Station,
    };

    std::vector<LldpSystemCapability> capabilities;
    ...
    if (bits == 0)
    {
        capabilities.push_back(LldpSystemCapability::None);
    }
    return capabilities;
}
...
void readManagementAddressField(std::span<const uint8_t> value,
                                LldpFrame& frame)
{
    if (value.empty())
    {
...
int parseLldpFrame(const std::span<const uint8_t> pdu, LldpFrame& frame)
{
    frame = LldpFrame{};
    ...
    while (cursor + tlvHeaderSize <= pdu.size())
    {
        ...
        if (type == tlvEndOfLldpdu)
        {
            ...
            if (length != 0 || expected != Mandatory::Done ||
