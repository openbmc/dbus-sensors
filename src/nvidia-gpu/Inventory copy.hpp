...
class Inventory
{
  ...
  private:
    void requestInventoryProperty(gpu::InventoryPropertyId propertyId, const std::string& dbusProperty, int& attempts);
    void handleInventoryPropertyResponse(gpu::InventoryPropertyId propertyId, const std::string& dbusProperty, int& attempts, int sendRecvMsgResult);
