    ...
    objectServer(objectServer)
{
    ...
    {
        lg2::error(
            "Failed to initialize SRAM ECC interface for {NAME}, eid={EID}",
    ...
    {
        lg2::error(
            "Failed to initialize Embedded interface for {NAME}, eid={EID}",
    ...
    {
        lg2::error(
            "Failed to initialize DRAM ECC interface for {NAME}, eid={EID}",
            "NAME", dramName, "EID", eid);
    }
}
