                                            ...
                                            std::span<const uint8_t> buffer)
{
    ...
    int64_t sramCeCount = eccResponse.sram_corrected;
    int64_t sramUeCount = (eccResponse.sram_uncorrected_secded +
    ...
    int64_t dramCeCount = eccResponse.dram_corrected;
    int64_t dramUeCount = eccResponse.dram_uncorrected;
