    ...
    public std::enable_shared_from_this<NvidiaGpuFirmwareInformation>
{
  public:
    ...
    NvidiaGpuFirmwareInformation(const NvidiaGpuFirmwareInformation&) = delete;
    NvidiaGpuFirmwareInformation& operator=(
        const NvidiaGpuFirmwareInformation&) = delete;
    NvidiaGpuFirmwareInformation(NvidiaGpuFirmwareInformation&&) = delete;
    NvidiaGpuFirmwareInformation& operator=(NvidiaGpuFirmwareInformation&&) =
        delete;
