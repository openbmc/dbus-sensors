 ...
 *
 * Manages GPU DRAM memory ECC interface.
 *
 * Note: DRAM inventory object and Item.Dimm interface are created by
 * Inventory.cpp. This class only adds MemoryECC interface to the existing
 * DRAM object.
 *
 * DRAM ECC D-Bus:
    ...
    public std::enable_shared_from_this<NvidiaGpuMemoryDevice>
{
  ...
  private:
    ...
    // DRAM ECC interface (on DRAM inventory object created by Inventory.cpp)
