 ...
 * Supports SRAM and DRAM ECC error monitoring.
 *
 * SRAM ECC D-Bus:
 ...
 *
 * DRAM ECC D-Bus:
 *   Object Path: /xyz/openbmc_project/inventory/{gpuName}_DRAM_0
 *   Interface: xyz.openbmc_project.Memory.MemoryECC (ceCount, ueCount)
 *
 * Association D-Bus:
 *   GPU Object: all_memory -> DRAM Object
 *   DRAM Object: parent_processor -> GPU Object
 */
    ...
    public std::enable_shared_from_this<NvidiaGpuMemoryDevice>
{
  public:
     ...
     * SRAM and DRAM ECC properties on D-Bus.
     */
    void update();
