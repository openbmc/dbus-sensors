...
void PcieDevice::read()
{
    ...
    if (supportedCommands->supports(NvidiaPcieFunction::requiredCommandV2))
    {
        pcieFunction->update();
    }
    if (supportedCommands->supports(NvidiaPciePortInfo::requiredCommandV2))
    {
    ...
    if (supportedCommands->supports(NvidiaPciePortMetrics::requiredCommandV2))
    {
