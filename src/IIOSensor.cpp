...
// readings is the hectopascal (hPa), in meteorology, for atmospheric pressure,
// the modern equivalent of the traditional millibar.
static constexpr unsigned int sensorScaleFactor = 10;
