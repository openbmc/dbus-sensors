...
{
    setupPowerMatchCallbacks(
        conn, [](bool power) { (void)power; }, [](bool post) { (void)post; });
}
...
void getDeviceMgmt(const DeviceTemplateMap& dtmap, const SensorBaseConfigMap& cfg,
