...
bool isPowerOn(const size_t slotId)
{
    ...
    {
        throw std::runtime_error("Slot " + std::to_string(slotId) + " Power Match Not Created");
    }
...
bool hasBiosPost(const size_t slotId)
{
    ...
    {
        throw std::runtime_error("Slot " + std::to_string(slotId) + "Post Match Not Created");
    }
...
bool isChassisOn(const size_t slotId)
{
    ...
    {
        throw std::runtime_error("Slot " + std::to_string(slotId) + "Chassis On Match Not Created");
    }
             ...
             slotNumber](sdbusplus::message_t& message) {
                ...
                if (findState != values.end())
                {
                    ...
                    if (it != chassisStatusOn.end())
                    {
                        ...
                        timerChassisOn->async_wait([hostStatusCallback, it,
                                                    slotNumber](
