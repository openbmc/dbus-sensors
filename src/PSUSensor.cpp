...
static constexpr double maxReading = 65535;
    ...
    waitTimer(io), errCount(0)
{
    ...
    switch (sensorType)
    {
        case SensorType::tempSensor:
            ...
            break;
        case SensorType::currSensor:
            sensorTypeName = "Current/";
            break;
        case SensorType::powerSensor:
            sensorTypeName = "Power/";
            break;
        case SensorType::voltSensor:
...
void PSUSensor::handleResponse(const boost::system::error_code& err)
{
    ...
    if (!err)
    {
        ...
        try
        {
            ...
            nvalue /= PSUSensor::sensorScaleFactor;
            if (overridenState)
            {
