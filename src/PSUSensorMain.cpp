...
void propertyInitialize(void)
{
    ...
    labelMatch = {
        ...
        {"power5", PSUProperty("Output Power", 3000, 0, 6, 0)},
        {"power6", PSUProperty("Output Power", 3000, 0, 6, 0)},
        {"power7", PSUProperty("Output Power", 3000, 0, 6, 0)},
        {"power8", PSUProperty("Output Power", 3000, 0, 6, 0)},
        {"power9", PSUProperty("Output Power", 3000, 0, 6, 0)},
        ...
        {"temp7", PSUProperty("Temperature", 127, -128, 3, 0)},
        {"temp8", PSUProperty("Temperature", 127, -128, 3, 0)},
