...
static boost::container::flat_map<std::string, std::string_view>
    sensorValuesUnit;
...
void propertyInitialize(void)
{
    ...
    sensorValuesUnit = {
        {"power", PSUSensor::Unit::Watts},   {"curr", PSUSensor::Unit::Amperes},
        {"temp", PSUSensor::Unit::DegreesC}, {"in", PSUSensor::Unit::Volts},
