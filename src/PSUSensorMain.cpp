    ...
    boost::container::flat_map<std::string, PSUProperty>& labelMatch)
{
    ...
    labelMatch = {
        {"pin", PSUProperty("Input Power", 3000, 0, 1000000)},
        {"pout1", PSUProperty("Output Power", 3000, 0, 1000000)},
        {"vin", PSUProperty("Input Voltage", 255, 0, 1000)},
        {"iin", PSUProperty("Input Current", 20, 0, 1000)},
        {"iout1", PSUProperty("Output Current", 255, 0, 1000)},
        {"temp1", PSUProperty("Inlet Temperature", 127, -128, 1000)},
        {"temp2", PSUProperty("Hot Spot Temperature", 127, -128, 1000)},
        {"fan1", PSUProperty("Fan Speed 1", 10000, 0, 1)},
        {"fan2", PSUProperty("Fan Speed 2", 10000, 0, 1)}};
}
