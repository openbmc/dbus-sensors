...
int main()
{
    std::vector<std::string> managerPaths = {"/xyz/openbmc_project/Chassis"};
    SensorReactor<ChassisIntrusionSensor> reactor(
        "xyz.openbmc_project.IntrusionSensor", false, managerPaths);
