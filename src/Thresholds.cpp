                                ...
                                double assertValue)
{
    ...
    // Check for an existing timer with the same level and direction but opposite assert state
    for (TimerPair& timer : timers)
    {
        ...
        {
            // If found, cancel the existing timer with the opposite assert state
            timer.second.cancel();
