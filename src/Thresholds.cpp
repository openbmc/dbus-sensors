                         ...
                         thresholds::Direction direction)
{
    ...
    switch (level)
    {
        ...
        case Level::SOFTSHUTDOWN:
            ...
            {
                threshold->assertedLog =
                    lg2::commit(Errors::ReadingAboveUpperSoftShutdownThreshold(
                        "SENSOR_NAME", objPath, "READING_VALUE", assertValue,
                        "UNITS", *unit, "THRESHOLD_VALUE", threshold->value));
            }
            else
            {
                threshold->assertedLog =
                    lg2::commit(Errors::ReadingBelowLowerSoftShutdownThreshold(
                        "SENSOR_NAME", objPath, "READING_VALUE", assertValue,
                        "UNITS", *unit, "THRESHOLD_VALUE", threshold->value));
            }
            break;
        case Level::HARDSHUTDOWN:
            ...
            {
                threshold->assertedLog =
                    lg2::commit(Errors::ReadingAboveUpperHardShutdownThreshold(
                        "SENSOR_NAME", objPath, "READING_VALUE", assertValue,
                        "UNITS", *unit, "THRESHOLD_VALUE", threshold->value));
            }
            else
            {
                threshold->assertedLog =
                    lg2::commit(Errors::ReadingBelowLowerHardShutdownThreshold(
                        "SENSOR_NAME", objPath, "READING_VALUE", assertValue,
                        "UNITS", *unit, "THRESHOLD_VALUE", threshold->value));
            }
            break;
