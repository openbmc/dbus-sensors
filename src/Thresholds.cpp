...
auto logAssertThresholdHelper(std::string objPath, double assertValue,
...
auto logAssertThreshold(Direction direction, std::string objPath,
                        double assertValue, Unit unit, double thresholdValue)
    -> sdbusplus::message::object_path
{
    namespace Errors =
        sdbusplus::error::xyz::openbmc_project::sensor::Threshold;
    ...
    {
        return logAssertThresholdHelper<highErrorObj>(objPath, assertValue,
                                                      unit, thresholdValue);
    }
    else
    {
        return logAssertThresholdHelper<lowErrorObj>(objPath, assertValue, unit,
                                                     thresholdValue);
    }
}
                         ...
                         thresholds::Direction direction)
{
    ...
    switch (level)
    {
        ...
        case Level::PERFORMANCELOSS:
            threshold->assertedLog = logAssertThreshold<
