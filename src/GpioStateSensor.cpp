...
static inline uint8_t ipmbGpioMax = 9;

static inline const char* gpioPathPrefix = "/xyz/openbmc_project/ipmbgpio/";
static inline const char* gpioInterfaceName =
    "xyz.openbmc_project.Chassis.Control.Gpio";
inline gpioMapType gpioMapName;
const char* gpioDbusProperty = "State";
