...
void MctpdEndpoint::subscribe(std::function<void(const std::shared_ptr<MctpEndpoint>& ep)>&& degraded,
...
std::shared_ptr<MctpDevice> MctpdEndpoint::device()
{
    return dev;
}
