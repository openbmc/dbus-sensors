                                   ...
                                   const SensorBaseConfigMap& iface)
{
    ...
    {
        throw std::invalid_argument(
            "Configuration object does not have type 'MCTPDevice'");
    }
    ...
    {
        throw std::invalid_argument(
            "Configuration object violates the MCTPDevice schema");
    }
                                     ...
                                     const SensorBaseConfigMap& iface)
{
    ...
    auto type = std::visit(VariantToStringVisitor(), mType->second);
    if (type != "MCTPInterface")
    {
        throw std::invalid_argument(
            "Configuration object does not have type 'MCTPInterface'");
    }
