    ...
    size_t retries = 0)
{
    ...
    {
        lg2::error(
            "types.emplace_back for getConfiguration, interface: {CONFIGNAME}",
            "CONFIGNAME", configInterfaceName(typePair.configName));
...
int main()
{
    ...
    {
        lg2::error(
            "types.emplace_back for setupPropertiesChangedMatches: {CONFIGNAME}",
            "CONFIGNAME", configInterfaceName(typePair.configName));
        types.emplace_back(typePair.configName);
    }
