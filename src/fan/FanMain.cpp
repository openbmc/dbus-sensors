...
int main()
{
    std::vector<std::string> managerPaths = {
        "/xyz/openbmc_project/sensors", "/xyz/openbmc_project/control",
        "/xyz/openbmc_project/inventory"};

    SensorReactor<TachSensor> reactor("xyz.openbmc_project.FanSensor", true,
                                      managerPaths);
