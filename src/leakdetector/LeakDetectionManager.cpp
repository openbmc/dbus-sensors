...
auto LeakDetectionManager::getDetectorConfig(
    ...
    -> sdbusplus::async::task<DetectorConfigIntf::DetectorConfig>
{
    DetectorConfigIntf::DetectorConfig config = {};
    ...
    config.type =
        DetectorConfigIntf::validDetectorTypes.find(co_await client.sub_type())
            ->second;
    config.pinName = co_await client.pin_name();
    config.polarity =
        DetectorConfigIntf::validPinPolarity.find(co_await client.polarity())
            ->second;
    config.level =
        DetectorConfigIntf::validDetectorLevel.find(co_await client.level())
            ->second;
