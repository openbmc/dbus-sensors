...
DetectionManager::DetectionManager(sdbusplus::async::context& ctx) :
    ctx(ctx),
    entityManager(ctx, {GPIODetectorConfigIntf::interface},
                  std::bind(&DetectionManager::processInventoryAdded, this,
                            std::placeholders::_1, std::placeholders::_2),
                  std::bind(&DetectionManager::processInventoryRemoved, this,
                            std::placeholders::_1, std::placeholders::_2)),
    leakEvents(ctx)
{
    ctx.spawn(startup());
        ...
        sdbusplus::message::object_path objectPath)
{
    ...
    auto client = GPIODetectorConfigIntf(ctx)
