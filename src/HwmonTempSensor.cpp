...
HwmonTempSensor::HwmonTempSensor(
    ...
    const double scaleValue, const double minReading, const double maxReading,
    ...
    offsetValue(offsetValue), scaleValue(scaleValue), minReading(minReading),
    maxReading(maxReading), units(units),
