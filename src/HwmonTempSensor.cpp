...
HwmonTempSensor::HwmonTempSensor(
    ...
    Sensor(
        boost::replace_all_copy(sensorName, " ", "_"), std::move(thresholdsIn),
        sensorConfiguration, objectType, false,
        sensorType == "pressure" ? maxReadingTemperature : maxReadingPressure,
        sensorType == "pressure" ? minReadingTemperature : minReadingPressure,
        conn, powerState),
