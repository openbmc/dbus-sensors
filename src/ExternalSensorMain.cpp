...
// Only one sensorType supported, thus no need for array of strings here
static std::string sensorType =
        ...
        [&io, &objectServer, &sensors, &dbusConnection,
         sensorsChanged](const ManagedObjectType& sensorConfigurations) {
                     ...
                     sensor : sensorConfigurations)
            {
                ...
                auto measureFound = baseConfigMap.find("Measure");
                if (measureFound == baseConfigMap.end())
                {
                    std::cerr << "Measure parameter not found for "
                              << interfacePath << "\n";
                    continue;
                }
                sensorMeasure =
