...
struct Sensor
{
    ...
    void updateInstrumentation(double readValue) const
    {
        ...
        {
            lg2::error("Sensor name: {NAME}, First reading: {VALUE}", "NAME",
        ...
        {
            lg2::error("Sensor name: {NAME}, Lowest reading: {VALUE}", "NAME",
                       name, "VALUE", readValue);
        ...
        {
            lg2::error("Sensor name: {NAME}, Highest reading: {VALUE}", "NAME",
                       name, "VALUE", readValue);
