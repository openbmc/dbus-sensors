...
/** @brief Type name to enum map */
static const auto validDetectorTypes =
    std::unordered_map<std::string, LeakDetectorIntf::DetectorType>{
        {"FloatSwitch", LeakDetectorIntf::DetectorType::FloatSwitch},
        {"MoistureSensor", LeakDetectorIntf::DetectorType::MoistureSensor},
        {"LeakSensingRope", LeakDetectorIntf::DetectorType::LeakSensingRope}};
...
struct DetectorConfig
{
    ...
    /** @brief Type */
    LeakDetectorIntf::DetectorType type =
        LeakDetectorIntf::DetectorType::Unknown;
    /** @brief Pin name */
...
class LeakDetector : public LeakDetectorIntf, public AssociationIntf
{
  public:
        ...
        config(config)
    {
        ...
        LeakDetectorIntf::type_ = config.type;
        if (!readState())
        {
