...
constexpr auto dbusService = "xyz.openbmc_project.LeakDetector";
...
class LeakDetector : public DetectorIntf, public GPIOIntf
{
  public:
    explicit LeakDetector(sdbusplus::async::context& ctx,
        ...
        GPIOIntf(ctx, dbusService, config.pinName), ctx(ctx),
  ...
  private:
    ...
    auto updateState(DetectorIntf::DetectorState newState)
