        ...
        [&io, &objectServer, &sensors, &dbusConnection,
         sensorsChanged](const ManagedObjectType& sensorConfigurations) {
            ...
            for (auto& path : paths)
            {
                ...
                double minValue = minValueTemperature;
                double maxValue = maxValueTemperature;
                ...
                {
                    minValue = minValuePressure;
                    maxValue = maxValuePressure;
                ...
                if (hwmonFile)
                {
                    sensor = std::make_shared<HwmonTempSensor>(
                        *hwmonFile, sensorType, objectServer, dbusConnection,
                        ...
                        offsetValue, scaleValue, minValue, maxValue, units,
                    ...
                    if (hwmonFile)
                    {
                        ...
                        sensor = std::make_shared<HwmonTempSensor>(
                            *hwmonFile, sensorType, objectServer,
                            ...
                            minValue, maxValue, units, pollRate, *interfacePath,
