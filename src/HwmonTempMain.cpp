...
static double readRawSensorCompValue(const char* path, const char* typeString)
{
    ...
    fprintf(stderr, "%s at %d in %s(): ", __FILE__, __LINE__, __func__);
    fprintf(stderr, "strlen(path) = %zd, path = %s\n", strlen(path), path);
    fprintf(stderr, "strlen(typeString) = %zd, typeString = %s\n",
            strlen(typeString), typeString);
    ...
    fprintf(stderr, "%s at %d in %s(): ", __FILE__, __LINE__, __func__);
    fprintf(stderr, "sensorCompFilename = %s\n", sensorCompFilename);
    ...
    fprintf(stderr, "%s at %d in %s(): ", __FILE__, __LINE__, __func__);
    fprintf(stderr, "sensorCompValueRead = %s\n", sensorCompValueRead);

    readRawSensorCompResult = strtod(sensorCompValueRead, nullptr);

    fprintf(stderr, "%s at %d in %s(): ", __FILE__, __LINE__, __func__);
    fprintf(stderr, "readRawSensorCompResult = %f\n", readRawSensorCompResult);
