...
constexpr int MP5920_VOLTAGE_m = 2450;
constexpr int MP5920_VOLTAGE_r = 1;
constexpr int MP5920_VOLTAGE_b = 0;

constexpr int MP5920_CURRENT_m = 944;
constexpr int MP5920_CURRENT_r = 2;
constexpr int MP5920_CURRENT_b = 0;

constexpr int MP5920_PWR_m = 9034;
constexpr int MP5920_PWR_b = 0;
constexpr int MP5920_PWR_r = 3;

// PMBus unit Information
struct SHSCDevInfo
    {
    bool bInit;  // TRUE if this device inited OK
