...
class GPIOSensorConfigListener
{
  ...
  private:
    ...
    {
        return {/*name*/ fromDbusProperty<std::string>(
                    properties, Properties::PropertyName),
                /*GpioLine*/
                fromDbusProperty<std::string>(properties,
                                              Properties::PropertyGpioLine),
                /*Polarity*/
                fromDbusProperty<std::string>(
                    properties, Properties::PropertyPolarity) == "active_low",
                /*functional*/ false,
                /*faultLedGroup*/
                fromDbusProperty<std::vector<std::string>>(
