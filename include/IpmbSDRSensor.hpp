...
struct SDR01DataFields
{
    ...
    uint8_t assertionMask[2];             // Byte 16, 17
    uint8_t reserveId1[2];                // Byte 18, 19
    uint8_t deassertionMask[2];           // Byte 20, 21
    uint8_t discreteMask[2];              // Byte 22, 23
    ...
    uint8_t reserveId2[2];                // Byte 36, 37
