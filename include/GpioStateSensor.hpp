...
using hostCtrlGpioMap = boost::container::flat_map<std::string, IpmbGpioInfo>;
static hostCtrlGpioMap twinlakeIpmbgpioMap = {
...
class IpmbGpioStateMonitor
{
  public:
    ...
    void read();
    void incrementError();
    std::optional<hostCtrlGpioMap> getHostCtrlGpioMap();
