...
struct Sensor
{
    ...
    // notification whenever this Sensor's value is externally set
    // via D-Bus. If interested, replace this variable with your own
    // lambda. See ExternalSensor for an example of usage.
