...
struct Sensor
{
    // Hardcoding enum-values of 'xyz.openbmc_project.Sensor.Value.Unit' property
    // by agreement that phosphor-dbus-interfaces won't be used as main API
    // engine.
    // See disscusion
    ...
    Sensor(const std::string& name,
           ...
           const double max, const double min, const std::string_view& unit,
